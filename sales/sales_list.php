    ...
    <div class="content">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form enctype="multipart/form-data" action="/sales/sales_list" class="filter_form" method="post">
                <div class="card" id="filter_inputs">
                    <div class="card-body pb-0">
                        <div class="row">
                            <div class="col-lg-2 col-sm-6 col-12">
                                <div class="form-group">
                                    <input type="text" placeholder="Enter Name" name="customer_name" id="customer_name">
                                </div>
                            </div>
                            <div class="col-lg-2 col-sm-6 col-12">
                                <div class="form-group">
                                    <input type="text" placeholder="Enter Reference No" name="reference_number" id="reference_number">
                                </div>
                            </div>
                            <div class="col-lg-2 col-sm-6 col-12">
                                <div class="form-group">
                ...
                <form enctype="multipart/form-data" action="/sales/sales_list" id="table_form" method="post">
