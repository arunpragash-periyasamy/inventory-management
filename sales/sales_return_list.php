<div class="page-wrapper">
    <div class="content">
        <div class="page-header">
            ...
            <div class="page-btn">
                <a href="add_sales_return" class="btn btn-added"><img src="/assets/img/icons/plus.svg" alt="img" class="me-2">Add New Sales Return</a>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form enctype="multipart/form-data" action="/sales/sales_return_list" class="filter_form" method="post">
                <div class="card" id="filter_inputs">
                    <div class="card-body pb-0">
                        <div class="row">
                            ...
                            <div class="col-lg-2 col-sm-6 col-12">
                                <div class="form-group">
                                    <select class="select "  name="customer_list" id="customer_list">
                            ...
                            <div class="col-lg-2 col-sm-6 col-12">
                                <div class="form-group">
                                    <select class="select "  name="payment_status" id="payment_status">
                    ...
                    <table class="table datanew">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a class="me-3" href="add_sales_return">
