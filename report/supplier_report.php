                ...
                <div class="tabs-set">
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="purchase" role="tabpanel" aria-labelledby="purchase-tab">
                            ...
                            <form enctype="multipart/form-data" action="/report/supplier_report" class="search_form" id="purchase" method="post">
                                    ...
                                    <div class="card-body pb-0">
                                        <div class="row">
                                            <div class="col-lg-2 col-sm-6 col-12">
                                                <div class="form-group">
                                                    <div class="input-groupicon">
                                                        <input type="text" placeholder="From Date" class="datetimepicker" name="from_date" id="from_date">
                                                        <div class="addonset">
                                            ...
                                            <div class="col-lg-2 col-sm-6 col-12">
                                                <div class="form-group">
                                                    <div class="input-groupicon">
                                                        <input type="text" placeholder="To Date" class="datetimepicker" name="to_date" id="to_date">
                                                        <div class="addonset">
                                                            <img src="/assets/img/icons/calendars.svg" alt="img">
                                                        </div>
                                                    </div>
                        ...
                        <div class="tab-pane fade" id="payment" role="tabpanel">
                            ...
                            <form enctype="multipart/form-data" action="/report/supplier_report" class="search_form" id="payment" method="post">
                        ...
                        <div class="tab-pane fade" id="return" role="tabpanel">
                            ...
                            <form enctype="multipart/form-data" action="/report/supplier_report" class="search_form" id="return" method="post">
