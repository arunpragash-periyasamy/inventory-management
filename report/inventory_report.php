<div class="page-wrapper">
    <div class="content">
        ...
        <div class="card">
            <div class="card-body">
                <form enctype="multipart/form-data" action="/report/inventory_report" class="search_form" method="post">
                ...
                <form enctype="multipart/form-data" action="/report/inventory_report" class="filter_form" method="post">
