<div class="page-wrapper">
    <div class="content">
        ...
        <div class="card">
            <div class="card-body">
                <form enctype="multipart/form-data" action="/report/purchase_order_report" class="search_form" method="post">
                    <div class="table-top">
                ...
                <form enctype="multipart/form-data" action="/report/purchase_order_report" class="filter_form" method="post">
