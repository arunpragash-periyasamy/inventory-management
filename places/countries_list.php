...
<div class="page-wrapper">
            <div class="content">
                ...
                <div class="card">
                    <div class="card-body">
                    <form enctype="multipart/form-data" action="/places/countries_list" id="search_form" method="post">
                    ...
                    <form enctype="multipart/form-data" action="/places/countries_list" id="filter_form" method="post">
