...
<div class="page-wrapper">
            <div class="content">
                ...
                <div class="card">
                    <div class="card-body">
                    <form enctype="multipart/form-data" action="/places/countries_list" class="search_form" method="post">
                    ...
                    <form enctype="multipart/form-data" action="/places/countries_list" class="filter_form" method="post">
                        ...
                        <div class="card" id="filter_inputs">
                            <div class="card-body pb-0">
                                <div class="row">
                                    ...
                                    <div class="col-lg-2 col-sm-6 col-12">
                                        <div class="form-group">
                                            <select class="select form-select" name="region" id="region">
