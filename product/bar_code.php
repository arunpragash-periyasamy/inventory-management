            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6 col-12">
                    <div class="form-group">
                        ...
                        <select class="select" name="bar_code_size" id="bar_code_size">
...
<div id="scanner" tabindex="-1" role="dialog" aria-hidden="true"> <!--if class="modal fade" then barcode will be hidden -->
