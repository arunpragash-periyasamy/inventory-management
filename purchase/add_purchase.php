<div class="page-wrapper">
    <div class="content">
        ...
        <form enctype="multipart/form-data" action="/purchase/add_purchase" class="new_form" method="post">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-sm-6 col-12">
                            <div class="form-group">
                                ...
                                <select class="select " name="product_name" id="product_name">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <a href="purchase_list" class="btn btn-cancel">Cancel</a>
                        </div>
                    </div>
                </div>
            </div>
